...
| `Signers` | [`List<Models.Signer>`](/doc/models/signer.md) | Required | - |
| `Status` | [`Models.Status`](/doc/models/status.md) | Required | - |
| `Title` | `string` | Required | - |
| `Description` | `string` | Required | - |
| `ExternalId` | `string` | Required | - |
| `DataToSign` | [`Models.DataToSign`](/doc/models/data-to-sign.md) | Required | - |
| `ContactDetails` | [`Models.ContactDetails`](/doc/models/contact-details.md) | Required | - |
| `Advanced` | [`Models.Advanced`](/doc/models/advanced.md) | Required | - |
